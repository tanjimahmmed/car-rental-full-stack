    ...
    const testimonials = [
        {
        ...
        },
         {
            ...
            testimonial: "Car Rental made my trip so much easier. The car was delivered right to my door, and there customer services was excellent!"
        },
         {
            name: "Ava Johnson",
            location: "Sydney, Australia",
            image: assets.testimonial_image_1,
            testimonial: "I highly recommend them. Their service was amazing"
        },
    ]
